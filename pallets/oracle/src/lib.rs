...
pub mod pallet {
    ...
    pub enum Error<T> {
        ...
        DuplicateRequest,
        /// Finalisation attempted but the response set did not reach the
        /// configured consensus threshold (quorum not met).
        QuorumNotMet,
    }
        ...
        BalanceOf<T>: From<u32>,
    {
        ...
        fn compute_factual_consensus(
            ...
            // saturating_mul guards overflow; checked_div(.max(1)) guards zero-divisor
