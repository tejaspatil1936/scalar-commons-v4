...
pub mod pallet {
    ...
    pub trait Config: frame_system::Config + agents_pallet::Config {
        ...
        /// Weight information for all oracle dispatchables.
    ...
    {
        #[pallet::call_index(0)]
        #[pallet::weight(T::WeightInfo::create_oracle_request())]
        ...
        #[pallet::call_index(2)]
        #[pallet::weight(T::WeightInfo::finalise_request())]
        ...
        #[pallet::call_index(4)]
        #[pallet::weight(T::WeightInfo::batch_submit_response())]
